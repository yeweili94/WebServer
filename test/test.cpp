...
int main()
{
    ...
    // time_t end;
    // time(&end);
    // printf("cost time %ld seconds", end - start);
    {
        std::unique_ptr<ActualClass> p1(new ActualClass);
        p1->print();
        std::unique_ptr<ActualClass> p2(new ActualClass);
        p2->print();
        std::unique_ptr<ActualClass> p3(new ActualClass);
        p3->print();
        std::unique_ptr<ActualClass> p4(new ActualClass);
        p4->print();
    }
    std::unique_ptr<ActualClass> p1(new ActualClass);
    p1->print();
